    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="flex items-center space-x-4">
                <div class="bg-white shadow-lg rounded-xl px-4 py-2 flex items-center">
                    ...
                    <span class="px-3 py-1 rounded-full text-sm font-semibold bg-indigo-100 text-indigo-800">
                        <?php echo e(auth()->user()->getRoleNames()->first() ?? 'Administrateur'); ?>

                    </span>
                </div>
                <a href="<?php echo e(route('profile.edit')); ?>" class="bg-white shadow-lg rounded-xl p-3 hover:bg-gray-50 transition-all duration-300 group">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 transform transition-all duration-300 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-indigo-600"><?php echo e($totalUsers); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <span class="text-sm text-green-600 font-medium">+<?php echo e($activeUsers); ?> actifs</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 transform transition-all duration-300 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600"><?php echo e(isset($products) ? count($products) : 0); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 transform transition-all duration-300 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600"><?php echo e($stats['total_orders'] ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 transform transition-all duration-300 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?php echo e($stats['total_transactions'] ?? 0); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <span class="text-sm text-gray-600"><?php echo e(number_format($stats['total_amount'] ?? 0, 0, ',', ' ')); ?> FCFA</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 transform transition-all duration-300 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-orange-600"><?php echo e($adminsCount); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-2xl shadow-xl p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="<?php echo e(route('products.create')); ?>" class="bg-indigo-600 text-white p-4 rounded-xl hover:bg-indigo-700 transition-colors text-center">
                    ...
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="bg-blue-600 text-white p-4 rounded-xl hover:bg-blue-700 transition-colors text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                        </svg>
                        Ajouter un utilisateur
                    </a>
                    <a href="<?php echo e(route('categories.create')); ?>" class="bg-purple-600 text-white p-4 rounded-xl hover:bg-purple-700 transition-colors text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                        </svg>
                        Gérer les catégories
                    </a>
                    <a href="<?php echo e(route('promos.create')); ?>" class="bg-green-600 text-white p-4 rounded-xl hover:bg-green-700 transition-colors text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Gérer les codes promos
                    </a>
                    <a href="<?php echo e(route('admin.transactions.index')); ?>" class="bg-yellow-600 text-white p-4 rounded-xl hover:bg-yellow-700 transition-colors text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                        </svg>
                        Gérer les transactions
                    </a>
                    <a href="<?php echo e(route('notifications.index')); ?>" class="bg-red-600 text-white p-4 rounded-xl hover:bg-red-700 transition-colors text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 lg:col-span-2">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php if(isset($stats['recent_orders']) && count($stats['recent_orders']) > 0): ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e($order->id); ?></td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e(optional($order->user)->name ?? 'Inconnu'); ?></td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e(number_format($order->total_price, 2)); ?> <?php echo e($order->currency); ?></td>
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($order->status == 'en attente' ? 'bg-yellow-100 text-yellow-800' : ($order->status == 'expédié' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800')); ?>">
                                            <?php echo e($order->status); ?>

                                        </span>
                                    </td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                        <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="text-indigo-600 hover:text-indigo-900">
                    ...
                    <div class="flex space-x-4">
                        <form action="<?php echo e(route('admin.dashboard')); ?>" method="GET" class="flex items-center">
                            <select name="filter" class="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg shadow-sm" onchange="this.form.submit()">
                                <option value="name_asc" <?php echo e(request('filter') == 'name_asc' ? 'selected' : ''); ?>>A-Z</option>
                                <option value="name_desc" <?php echo e(request('filter') == 'name_desc' ? 'selected' : ''); ?>>Z-A</option>
                                <option value="price_asc" <?php echo e(request('filter') == 'price_asc' ? 'selected' : ''); ?>>Prix ↑</option>
                                <option value="price_desc" <?php echo e(request('filter') == 'price_desc' ? 'selected' : ''); ?>>Prix ↓</option>
                            </select>
                        </form>
                        <form action="<?php echo e(route('admin.dashboard')); ?>" method="GET" class="flex items-center">
                            <input type="text" name="name" value="<?php echo e(request('name')); ?>" class="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg shadow-sm" placeholder="Rechercher" onchange="this.form.submit()">
                        </form>
                    </div>
                </div>
                            ...
                            <?php if(isset($products) && count($products) > 0): ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-lg object-cover" src="<?php echo e($product->image); ?>" alt="<?php echo e($product->name); ?>">
                                            </div>
                                            <div class="ml-3">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        <?php if(isset($product->currency) && $product->currency === 'XOF'): ?>
                                            FCFA
                                        <?php else: ?>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex space-x-2">
                                            <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('admin.users.create')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                    Ajouter un utilisateur
                        ...
                        <?php if(isset($users) && count($users) > 0): ?>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e($user->profile_photo_url); ?>" alt="<?php echo e($user->name); ?>">
                                        </div>
                                        <div class="ml-3">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </a>
                                        <?php if($user->id !== auth()->id()): ?>
                                            <button onclick="showBlockModal(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', <?php echo e($user->is_blocked ? 'true' : 'false'); ?>)" class="flex items-center gap-1 px-3 py-1 font-bold uppercase tracking-wide rounded-lg shadow-sm transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500 <?php echo e($user->is_blocked ? 'bg-green-100 text-green-800 border border-green-300 hover:bg-green-200' : 'bg-red-600 text-white border border-red-700 hover:bg-red-700'); ?>">
                                            ...
                                            <button type="button" class="text-red-600 hover:text-red-900" onclick="openDeleteModal('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                </svg>
                                            </button>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (ctx) {
            var chart = new Chart(ctx.getContext('2d'), {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode(array_values($orderStatusLabels ?? [])); ?>,
                    datasets: [{
                        label: 'Commandes',
                        data: <?php echo json_encode(array_values($orderStatusCounts ?? [])); ?>,
                        backgroundColor: [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Projets\mon-site-cosmetique\mon-site-cosmetique\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>