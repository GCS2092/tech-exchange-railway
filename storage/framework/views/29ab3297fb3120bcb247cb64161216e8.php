...
<?php $component->withAttributes([]); ?>
        ...
        <form method="POST" action="<?php echo e(route('password.code.check')); ?>">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'code','value' => __('Code reçu par email')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'code','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Code reçu par email'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'code','class' => 'block mt-1 w-full','type' => 'text','name' => 'code','maxlength' => '6','required' => true,'pattern' => '[0-9]{6}','placeholder' => '123456','autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'code','class' => 'block mt-1 w-full','type' => 'text','name' => 'code','maxlength' => '6','required' => true,'pattern' => '[0-9]{6}','placeholder' => '123456','autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(__('Vérifier le code')); ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('password.code.send')); ?>" class="mt-4">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="email" value="<?php echo e($email); ?>" />
...
<?php endif; ?> <?php /**PATH C:\Projets\mon-site-cosmetique\mon-site-cosmetique\resources\views/auth/passwords/verify-code.blade.php ENDPATH**/ ?>