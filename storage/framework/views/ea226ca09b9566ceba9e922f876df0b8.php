...
<?php $component->withAttributes([]); ?>
        ...
        <form method="POST" action="<?php echo e(route('password.code.send')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Projets\mon-site-cosmetique\mon-site-cosmetique\resources\views/auth/passwords/request-code.blade.php ENDPATH**/ ?>