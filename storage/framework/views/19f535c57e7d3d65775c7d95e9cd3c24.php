...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="flex mb-8" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="<?php echo e(route('products.index')); ?>" class="text-gray-700 hover:text-pink-600 inline-flex items-center transition-colors duration-300">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-gray-500 ml-1 md:ml-2 text-sm font-medium"><?php echo e($product->name); ?></span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 transform hover:shadow-2xl transition-all duration-300">
            ...
            <!-- Product Title -->
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-4"><?php echo e($product->name); ?></h1>
            ...
            <div class="mb-6">
                ...
                <?php if($product->old_price > $product->price): ?>
                    <span class="text-gray-400 line-through text-lg mr-2"><?php echo e(\App\Helpers\CurrencyHelper::format($product->old_price, $currentCurrency)); ?></span>
                <?php endif; ?>
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm sm:text-base"><?php echo e($product->description); ?></p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                <?php if($product->is_active): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login', ['redirect' => url()->current()])); ?>" class="w-full bg-gradient-to-r from-pink-600 to-purple-600 text-white py-3 px-6 rounded-xl font-bold tracking-wide 
                            hover:from-pink-700 hover:to-purple-700 transform hover:-translate-y-1 hover:shadow-lg 
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if($isFavorite): ?>
                        <form action="<?php echo e(route('favorites.remove', $product)); ?>" method="POST" class="flex-1">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        <form action="<?php echo e(route('favorites.add', $product)); ?>" method="POST" class="flex-1">
                            <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-800 group-hover:text-pink-600 transition-colors"><?php echo e($relatedProduct->name); ?></h3>
                        <p class="text-pink-600 font-bold mt-2"><?php echo e(\App\Helpers\CurrencyHelper::format($relatedProduct->price, $currentCurrency)); ?></p>
                        <a href="<?php echo e(route('products.show', $relatedProduct->id)); ?>" class="mt-4 inline-block text-pink-600 hover:text-pink-700 font-medium transition-colors duration-300">
                            Voir le produit
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.onboarding-button','data' => ['tourId' => 'product-show','position' => 'fixed']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['tourId' => 'product-show','position' => 'fixed']); ?>
