...
<div class="min-h-screen bg-gradient-to-r from-indigo-700 via-purple-600 to-indigo-600 flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md backdrop-filter backdrop-blur-lg bg-white bg-opacity-10 rounded-2xl shadow-2xl p-8 border border-white border-opacity-20 text-center">
        ...
        <div class="mt-8">
            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center px-6 py-3 bg-white text-indigo-700 font-bold rounded-lg shadow-lg hover:bg-indigo-50 transition-all duration-300 transform hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50 group">
        ...
        <div class="mt-12 flex justify-center space-x-4">
            <a href="<?php echo e(route('home')); ?>" class="text-indigo-100 hover:text-white transition-colors duration-300 flex items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Projets\mon-site-cosmetique\mon-site-cosmetique\resources\views/auth/goodbye.blade.php ENDPATH**/ ?>