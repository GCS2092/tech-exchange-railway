...
<body class="flex flex-col min-h-screen">
    ...
    <nav class="glass sticky top-0 z-50 py-4 px-6 md:px-8 shadow-lg">
        <div class="container mx-auto flex justify-between items-center">
            <!-- Logo/Brand -->
            <a href="<?php echo e(route('dashboard')); ?>" class="brand flex items-center">
...
<div class="hidden md:flex space-x-8">
    <a href="<?php echo e(route('dashboard')); ?>" class="nav-link active">Accueil</a>
    <a href="<?php echo e(route('products.index')); ?>" class="nav-link">Produits</a>
    <a href="<?php echo e(route('orders.index')); ?>" class="nav-link">Commandes</a>
    <a href="<?php echo e(route('promos.index')); ?>" class="nav-link">Codes Promos</a>
    <a href="<?php echo e(route('fidelity.calendar')); ?>" class="nav-link">Fidélité</a>
    <a href="<?php echo e(route('favorites.index')); ?>" class="nav-link">Coup De Coeur</a>
</div>
            ...
            <div class="flex space-x-6 items-center">
                ...
                <div class="relative">
                    <select name="currency" id="currency-selector" class="form-control py-2 pl-9 pr-10 text-sm" onchange="changeCurrency(this.value)">
                        <option value="XOF" <?php echo e($currentCurrency == 'XOF' ? 'selected' : ''); ?>>XOF (FCFA)</option>
                        <option value="EUR" <?php echo e($currentCurrency == 'EUR' ? 'selected' : ''); ?>>EUR (€)</option>
                        <option value="USD" <?php echo e($currentCurrency == 'USD' ? 'selected' : ''); ?>>USD ($)</option>
                    </select>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <div id="userDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl py-2 hidden z-50">
                            <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-2 text-gray-800 hover:bg-indigo-100 flex items-center">
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 text-gray-800 hover:bg-indigo-100 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-indigo-600" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                                </svg>
                                Mon profil
                            </a>
                            <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-2 text-gray-800 hover:bg-indigo-100 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-indigo-600" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 text-gray-800 hover:bg-indigo-100 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-indigo-600" viewBox="0 0 20 20" fill="currentColor">
                ...
                <?php else: ?>
                    <div class="flex items-center space-x-2">
                        <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-md transform transition-transform hover:-translate-y-1 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1zm7.707 3.293a1 1 0 010 1.414L9.414 9H17a1 1 0 110 2H9.414l1.293 1.293a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            <span>Connexion</span>
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-white hover:bg-gray-100 text-indigo-700 border border-indigo-300 rounded-lg shadow-md transform transition-transform hover:-translate-y-1 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <?php endif; ?>
                    ...
                    <div id="userDropdown" class="absolute right-0 mt-3 w-64 bg-white shadow-xl rounded-xl z-50 hidden overflow-hidden fade-in transform origin-top-right">
                        <div class="px-4 py-3 bg-gradient-to-r from-pink-400 to-purple-500 text-white">
                            <p class="text-sm font-bold"><?php echo e(Auth::user()->name ?? 'Bienvenue'); ?></p>
                            <p class="text-xs opacity-80"><?php echo e(Auth::user()->email ?? 'Connectez-vous pour continuer'); ?></p>
                        </div>
                        <div id="userDropdown" class="absolute right-0 mt-3 w-64 bg-white shadow-xl rounded-xl z-50 hidden overflow-hidden fade-in transform origin-top-right">
                            <div class="px-4 py-3 bg-gradient-to-r from-pink-400 to-purple-500 text-white">
                                <p class="text-sm font-bold"><?php echo e(Auth::user()->name ?? 'Bienvenue'); ?></p>
                            ...
                            <div class="py-2">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition duration-200 flex items-center">
                                    <i class="fas fa-user-circle mr-3 text-gray-400"></i> Mon Profil
                                </a>
                                <?php if(Auth::check()): ?>
                                    <!-- Ajout du lien vers les favoris -->
                                    <a href="<?php echo e(route('favorites.index')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition duration-200 flex items-center">
                                        <i class="fas fa-heart mr-3 text-gray-400"></i> Mes Favoris
                                    </a>
                                    <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition duration-200 flex items-center">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition duration-200 flex items-center">
                                        <i class="fas fa-sign-in-alt mr-3 text-gray-400"></i> Connexion
                                    </a>
                                    <a href="<?php echo e(route('register')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition duration-200 flex items-center">
    ...
    <main class="flex-grow container mx-auto px-4 py-8">
                ...
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 md:pr-12 text-center md:text-left mb-10 md:mb-0">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-6">
                            <a href="<?php echo e(route('products.index')); ?>" class="btn-primary text-center">
                    ...
                    <div class="md:w-1/2 relative flex flex-col items-center justify-center gap-6">
                        <?php $firstTwo = $products->take(2); ?>
                        <div class="flex flex-col sm:flex-row gap-6 w-full justify-center items-center">
                            <?php $__currentLoopData = $firstTwo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('products.show', $product->id)); ?>" class="group block w-64 h-64 md:w-72 md:h-72 rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300 relative bg-white/30">
                                    <img src="<?php echo e(Str::startsWith($product->image, 'http') ? $product->image : asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                                        <span class="text-white text-lg font-bold drop-shadow"><?php echo e($product->name); ?></span>
                                    </div>
                                </a>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            <form action="<?php echo e(route('products.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <!-- 🔍 Recherche par nom -->
                <div class="relative">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        <select name="price_range" id="price_range" 
                            ...
                            <option value="0-20" <?php echo e(request('price_range') == '0-20' ? 'selected' : ''); ?>>Moins de 20€</option>
                            <option value="20-50" <?php echo e(request('price_range') == '20-50' ? 'selected' : ''); ?>>20€ - 50€</option>
                            <option value="50-100" <?php echo e(request('price_range') == '50-100' ? 'selected' : ''); ?>>50€ - 100€</option>
                            <option value="100+" <?php echo e(request('price_range') == '100+' ? 'selected' : ''); ?>>Plus de 100€</option>
                        </select>
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none">
                            <i class="fas fa-chevron-down"></i>
                        </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        <select name="sort" id="sort" 
                            ...
                            <option value="newest" <?php echo e(request('sort') == 'newest' ? 'selected' : ''); ?>>Plus récent</option>
                        </select>
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none">
                            <i class="fas fa-chevron-down"></i>
                        </div>
            ...
            <?php if(auth()->check() && auth()->user()->isAdmin()): ?>
                <div class="mt-6 flex justify-between items-center bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl">
                    ...
                    <form method="GET" action="<?php echo e(route('products.index')); ?>" class="flex">
                        <select name="filter" onchange="this.form.submit()" 
                            ...
                            <option value="active" <?php echo e(request('filter') == 'active' ? 'selected' : ''); ?>>En Stocks</option>
                            <option value="inactive" <?php echo e(request('filter') == 'inactive' ? 'selected' : ''); ?>>En Rupture</option>
                        </select>
                    </form>
                </div>
            <?php endif; ?>
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group flex flex-col h-full">
                        ...
                        <div class="relative h-56 sm:h-64 overflow-hidden flex-shrink-0">
                            <img 
                                src="<?php echo e(Str::startsWith($product->image, 'http') 
                                    ? $product->image 
                            ...
                            <div class="absolute top-4 right-4 space-y-2 z-10">
                                <!-- Admin Status Badge -->
                                <?php if(auth()->check() && auth()->user()->isAdmin()): ?>
                                    <span class="<?php echo e($product->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?> text-xs px-3 py-1 rounded-full font-medium flex items-center shadow-lg">
                                        <i class="fas <?php echo e($product->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-1"></i>
                                        <?php echo e($product->is_active ? 'Actif' : 'Inactif'); ?>

                                    </span>
                                <?php endif; ?>
                                <!-- Quick View Button -->
                                <a href="<?php echo e(route('products.show', $product->id)); ?>" class="w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-pink-500 transition-all duration-300 hover:bg-pink-50 transform hover:scale-110" title="Voir le détail du produit">
                        ...
                        <div class="p-4 flex flex-col flex-1">
                            ...
                            <h3 class="text-lg font-semibold mb-1 group-hover:text-pink-600 transition-colors duration-300 truncate"><?php echo e($product->name); ?></h3>
                            <p class="text-gray-600 mb-2 text-sm line-clamp-2"><?php echo e($product->description); ?></p>
                            <!-- Price and Status -->
                            <div class="flex flex-wrap justify-between items-center mb-3 gap-2">
                                <div class="flex items-baseline">
                                    <?php if($product->old_price > $product->price): ?>
                                        <span class="text-sm text-gray-400 line-through mr-2"><?php echo e(\App\Helpers\CurrencyHelper::format($product->old_price, $currentCurrency)); ?></span>
                                    <?php endif; ?>
                                    <p class="text-pink-600 font-bold text-lg">
                                        <?php echo e(\App\Helpers\CurrencyHelper::format($product->price, $currentCurrency)); ?>
                            ...
                            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-full mt-auto">
                                <?php if($product->is_active): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login', ['redirect' => url()->current()])); ?>" class="w-full bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 py-2 rounded-xl flex items-center justify-center hover:from-pink-600 hover:to-purple-600 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl text-sm">
                                            <i class="fas fa-shopping-cart mr-2"></i>
                                            Ajouter au panier
                                        </a>
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        ...
                                        <?php else: ?>
                                            <form action="<?php echo e(route('favorites.add', $product)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                ...
                                <?php endif; ?>
                                <?php if(auth()->check() && auth()->user()->isAdmin()): ?>
                                    <form action="<?php echo e(route('products.toggleActive', $product->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <button type="submit" 
                                            class="<?php echo e($product->is_active ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-green-500 hover:bg-green-600'); ?> text-white px-4 py-2 rounded-xl transition-all duration-300 w-full flex items-center justify-center transform hover:-translate-y-1 shadow-lg hover:shadow-xl text-sm mt-2 sm:mt-0">
                                            <i class="fas <?php echo e($product->is_active ? 'fa-toggle-off' : 'fa-toggle-on'); ?> mr-2"></i>
                                            <?php echo e($product->is_active ? 'Désactiver' : 'Activer'); ?>
    ...
    <footer class="bg-gray-900 text-white py-12 mt-auto">
        <div class="container mx-auto px-4">
            ...
            <div class="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500">&copy; <?php echo e(date('Y')); ?> Luxe Cosmétique. Tous droits réservés.</p>
    ...
    <script>
        function changeCurrency(currency) {
            ...
            form.method = 'POST';
            form.action = "<?php echo e(route('currency.change')); ?>";
    ...
    <script>
        function applyFilters() {
            const data = {
                ...
                currency: "<?php echo e($currentCurrency); ?>" // Ajouter la devise actuelle
            };
            ...
            fetch("<?php echo e(route('products.ajax.filter')); ?>?" + new URLSearchParams(data), {
                headers: {
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Projets\mon-site-cosmetique\mon-site-cosmetique\resources\views/products/index.blade.php ENDPATH**/ ?>