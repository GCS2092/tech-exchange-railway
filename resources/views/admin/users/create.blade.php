                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               id="name"
                                               value="{{ old('name') }}" 
                                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('name') border-red-300 focus:ring-gray-500 @enderror" 
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               id="username"
                                               value="{{ old('username') }}" 
                                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('username') border-red-300 focus:ring-gray-500 @enderror" 
                                               placeholder="Ex: jean.dupont" 
                                               required>
                                        @error('username')
                                            <p class="mt-1 text-sm text-black">{{ $message }}</p>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="email" 
                                               ...
                                               id="email"
                                               value="{{ old('email') }}" 
                                               class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('email') border-red-300 focus:ring-gray-500 @enderror" 
                                    ...
                                    <div>
                                        ...
                                        <select name="role" 
                                                id="role"
                                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('role') border-red-300 focus:ring-gray-500 @enderror" 
                                                required>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="password" 
                                                   name="password" 
                                                   id="password"
                                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('password') border-red-300 focus:ring-gray-500 @enderror" 
                                                   placeholder="••••••••" 
                                                   required 
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="password" 
                                                   ...
                                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('password_confirmation') border-red-300 focus:ring-gray-500 @enderror" 
                                                   placeholder="••••••••" 
                                                   required>
                                            <button type="button" 
                                                    class="absolute inset-y-0 right-0 pr-3 flex items-center"
