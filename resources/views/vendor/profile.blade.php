...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            <h1 class="text-xl font-bold text-gray-900 mb-2">Profil Vendeur</h1>
            <p class="text-gray-600">Gérez vos informations personnelles et vos paramètres de vente</p>
        </div>
            ...
            <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea 
                        ...
                        placeholder="Adresse de votre entreprise ou boutique"
        ...
        <div class="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-green-600 font-semibold">Vendeur actif</p>
                <p class="text-gray-500 text-sm mt-1">Votre boutique est opérationnelle</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-gray-900 font-semibold">Ventes</h3>
                </div>
                <p class="text-2xl font-bold text-blue-600">{{ $user->products()->count() }}</p>
                <p class="text-gray-500 text-sm mt-1">Produits en vente</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-gray-900 font-semibold">Promotions</h3>
                </div>
                <p class="text-2xl font-bold text-purple-600">{{ $user->promotions()->where('is_active', true)->count() }}</p>
                <p class="text-gray-500 text-sm mt-1">Promotions actives</p>
            </div>
        </div>
    </div>
</div>
