            ...
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required
                                value="{{ old('email') }}"
                                class="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent backdrop-blur-sm transition-all duration-300 @error('email') border-red-500/50 @enderror"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required
                                class="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent backdrop-blur-sm transition-all duration-300 @error('password') border-red-500/50 @enderror"
                                placeholder="••••••••"
                            >
                        </div>
                        @error('password')
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.code.request'))
                            <a href="{{ route('password.code.request') }}" class="text-sm text-pink-400 hover:text-pink-300 transition-colors duration-200">
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-300">
                        ...
                        <a href="{{ route('register') }}" class="text-pink-400 hover:text-pink-300 font-semibold transition-colors duration-200">
